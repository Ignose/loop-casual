...
const context = await esbuild.context({
  ...
  entryPoints: {
    "KoLmafia/scripts/loopcasual/loopcasual": "src/main.ts",
    "KoLmafia/scripts/loopcasual/loopcasual_choice": "src/standalone/loopcasual_choice.ts",
    "KoLmafia/relay/relay_loopcasual": "src/relay.ts",
  },
  entryNames: "[dir]/[name]",
  outdir: "dist",
