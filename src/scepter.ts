...
import { garboAverageValue, garboValue, getBestLuckyAdventure } from "./lib";
...
function summonTask({ skill }: ScepterSkill): Task {
  return {
    name: skill.name,
...
export function augustSummonTasks(): Task[] {
